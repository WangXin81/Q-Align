...
import openai
from model.LLM.GPT_module_global import LLMModule
from model.pipeline_global import VQA_Pipeline
...
def main():
    ...
    with open("data/OKVQA truly last/local_all.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    ...
    #数据加载
    question_json_path = os.path.join(project_root, "data", "ok_vqa", "OpenEnded_mscoco_val2014_questions.json")
    annotation_json_path = os.path.join(project_root, "data", "ok_vqa", "mscoco_val2014_annotations.json")
