import torch
from model.LLM.answer_gpt import answer_question_global,answer_question_local
...
class LLMModule:
    ...
    def forward(self, question, image_caption, boxes_caption):
        """
        综合处理：生成答案
        ...
        answer = answer_question_local(image_caption, boxes_caption,question,self.model)
        return answer
